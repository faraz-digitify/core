package com.yap.base.extensions
...
fun View.keyBoardListener(
    currentWindow: Window,
    callBack: (isKeyBoardShowing: Boolean) -> Unit
) {
    ...
    ViewCompat.setOnApplyWindowInsetsListener(this) { view, insets ->
        ...
        view.translationY = -(sysWindow?.bottom?.toFloat() ?: 0f)
        callBack.invoke(insets?.isVisible(WindowInsetsCompat.Type.ime()) == true)
        insets
    }
}
