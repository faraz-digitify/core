...
import com.yap.base.animations.animators.*
...
object AnimationUtils {
    ...
    fun startAnimation(context: Context, view: View, animation: Int) {
        val animShake = AnimationUtils.loadAnimation(context, animation)
