...
import com.yap.core.databinding.SnackbarFireBinding

class NetworkXFireSnackbar private constructor(
    parent: ViewGroup,
    private val binding: SnackbarFireBinding,
    callback: com.google.android.material.snackbar.ContentViewCallback
) : BaseTransientBottomBar<NetworkXFireSnackbar>(parent, binding.root, callback) {
    ...
    companion object {
        ...
        fun make(
            ...
            val snackbar = NetworkXFireSnackbar(
                parent,
                binding,
            ...
            snackbar.addCallback(object : BaseCallback<NetworkXFireSnackbar>() {
                override fun onDismissed(transientBottomBar: NetworkXFireSnackbar?, event: Int) {

                }

                override fun onShown(transientBottomBar: NetworkXFireSnackbar?) {
     ...
     */
    fun setText(text: CharSequence): NetworkXFireSnackbar {
